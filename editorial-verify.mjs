...
if (!desktop.lead?.includes('Interpretation')) throw new Error('Editorial interpretation content missing.');
if (desktop.method) throw new Error('Methodology panel should be removed from editorial section.');
