...
export const empires: readonly Empire[] = [
  {
    ...
    events: [
      { id: 'zama', year: -202, title: 'Battle of Zama', type: 'battle', summary: 'Roman victory over Hannibal ends the Second Punic War and reshapes western Mediterranean power.', location: { lat: 36.19, lon: 9.22 }, source: 'Punic Wars' },
      { id: 'actium', year: -31, title: 'Battle of Actium', type: 'battle', summary: 'Octavian defeats Antony and Cleopatra, clearing the path to imperial rule.', location: { lat: 38.95, lon: 20.75 }, source: 'Battle of Actium' },
      ...
      { id: 'adrianople', year: 378, title: 'Battle of Adrianople', type: 'battle', summary: 'Gothic forces defeat the eastern field army, exposing deep frontier stress.', location: { lat: 41.68, lon: 26.56 }, source: 'Battle of Adrianople' },
...

  {
    ...
    events: [
      ...
      { id: 'paris-1783', year: 1783, title: 'Treaty of Paris', type: 'treaty', summary: 'Britain recognises U.S. independence and a boundary to the Mississippi River.', location: { lat: 48.8566, lon: 2.3522 }, source: 'Treaty of Paris (1783)' },
      { id: 'louisiana', year: 1803, title: 'Louisiana Purchase', type: 'expansion', summary: 'The U.S. purchases France’s claim to Louisiana, dramatically expanding westward.', location: { lat: 29.9511, lon: -90.0715 }, source: 'Louisiana Purchase' },
      { id: 'mexican-cession', year: 1848, title: 'Treaty of Guadalupe Hidalgo', type: 'treaty', summary: 'The Mexican-American War settlement transfers a vast western territory to the U.S.', location: { lat: 19.4, lon: -99.13 }, source: 'Mexican Cession' },
