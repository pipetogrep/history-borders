...
export const sourceCatalog: Record<string, SourceInfo> = {
  ...
  'Adams–Onís Treaty': { title: 'Adams–Onís Treaty', url: 'https://en.wikipedia.org/wiki/Adams%E2%80%93On%C3%ADs_Treaty', kind: 'treaty', note: 'Florida cession and transcontinental boundary settlement with Spain.' },
  'Oregon Treaty': { title: 'Oregon Treaty', url: 'https://en.wikipedia.org/wiki/Oregon_Treaty', kind: 'treaty', note: 'Boundary agreement between the United States and Britain in the Pacific Northwest.' },
  'Treaty of Guadalupe Hidalgo': { title: 'Treaty of Guadalupe Hidalgo', url: 'https://en.wikipedia.org/wiki/Treaty_of_Guadalupe_Hidalgo', kind: 'treaty', note: 'Treaty ending the Mexican-American War and transferring the Mexican Cession.' },
  'Gadsden Purchase': { title: 'Gadsden Purchase', url: 'https://en.wikipedia.org/wiki/Gadsden_Purchase', kind: 'treaty', note: 'Southern Arizona/New Mexico acquisition and boundary adjustment.' },
  'Alaska Purchase': { title: 'Alaska Purchase', url: 'https://en.wikipedia.org/wiki/Alaska_Purchase', kind: 'treaty', note: 'Acquisition of Alaska from the Russian Empire.' },
  'Newlands Resolution': { title: 'Newlands Resolution', url: 'https://en.wikipedia.org/wiki/Newlands_Resolution', kind: 'legal source', note: 'Congressional annexation framework for Hawaii.' },
